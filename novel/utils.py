...
class Tool(object):
    ...
    def __init__(self,
        ...
        self._remove_div1 = re.compile(r'<div.*?/>', re.I | re.S)
        ...
        self._replace_and = re.compile(r'&amp;')
        self._replace_quote = re.compile(r'&quot;')
    ...
    def replace(self, text):
        ...
        if self.remove_div:
            text = re.sub(self._remove_div1, '', text)
        ...
        text = re.sub(self._replace_and, '&', text)
        text = re.sub(self._replace_quote, '"', text)
